...
<section class="defalt-container-style text-white d-flex justify-content-between align-items-center container">
    <div class="">
        <h5 style="margin:0; text-transform: uppercase;">
            Welcome
        </h5>
    </div>
    <div>
        ...
        %>
        <a href="./admin.jsp" class="btn btn-success btn-sm">Admin Panel</a>
        <%
            }
        %>
        <a href="./orders.jsp" class="btn btn-warning ml-3 btn-sm">My Orders</a>

        <a href="./cart.jsp" class="btn btn-primary btn-sm">
